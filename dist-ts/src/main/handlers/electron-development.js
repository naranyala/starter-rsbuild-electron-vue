...
export function registerElectronDevelopmentHandler() {
    ipcMain.handle('use-case:electron-development', async (event, data) => {
        try {
            ...
            console.error('Error in electron-development handler:', error instanceof Error ? error.message : String(error));
            return {
                success: false,
...
//# sourceMappingURL=electron-development.js.map