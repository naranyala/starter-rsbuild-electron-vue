...
export function registerElectronSecurityHandler() {
    ipcMain.handle('use-case:electron-security', async (event, data) => {
        try {
            ...
            console.error('Error in electron-security handler:', error instanceof Error ? error.message : String(error));
            return {
                success: false,
...
//# sourceMappingURL=electron-security.js.map