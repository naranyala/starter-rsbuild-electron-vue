...
export function registerElectronPackagingHandler() {
    ipcMain.handle('use-case:electron-packaging', async (event, data) => {
        try {
            ...
            console.error('Error in electron-packaging handler:', error instanceof Error ? error.message : String(error));
            return {
                success: false,
...
//# sourceMappingURL=electron-packaging.js.map