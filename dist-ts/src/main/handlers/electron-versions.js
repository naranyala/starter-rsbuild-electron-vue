...
export function registerElectronVersionsHandler() {
    ipcMain.handle('use-case:electron-versions', async (event, data) => {
        try {
            ...
            console.error('Error in electron-versions handler:', error instanceof Error ? error.message : String(error));
            return {
                success: false,
...
//# sourceMappingURL=electron-versions.js.map