...
export function registerElectronNativeAPIsHandler() {
    ipcMain.handle('use-case:electron-native-apis', async (event, data) => {
        try {
            ...
            console.error('Error in electron-native-apis handler:', error instanceof Error ? error.message : String(error));
            return {
                success: false,
...
//# sourceMappingURL=electron-native-apis.js.map