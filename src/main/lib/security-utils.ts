 ...
 */
export function setContentSecurityPolicy(policy: string, options: {
 ...
 */
export function createSecureWindowConfig(options: Electron.BrowserWindowConstructorOptions = {}): Electron.BrowserWindowConstructorOptions {
 ...
 */
export function validateJWT(token: string, secret: string): any | null {
  try {
